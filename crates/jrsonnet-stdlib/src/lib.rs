...
/// Rustanka: go-jsonnet vs jrsonnet YAML formatting (for Tanka compatibility)
/// Controls how quote_values is determined in manifestYamlDoc
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default, Acyclic)]
...
#[derive(Debug, Clone, Default, Acyclic)]
