//! Helm-compatible template functions
//!
//! These functions implement the list of functions available in Helm.
//! <https://helm.sh/docs/chart_template_guide/function_list/>
//!
//! Enable with the `helm-functions` feature flag.
...
// Re-export value_is_truthy
pub use logic::value_is_truthy;

/// Helm-compatible template functions
///
/// This array contains all the Helm template functions.
/// Functions are organized by category in separate modules.
pub const HELM_FUNCTIONS: [(&str, Func); 152] = [
    // Logic functions
    ...
    (
        ...
        regex::regex_replace_all_literal as Func,
    ),
    (
        "mustRegexReplaceAllLiteral",
        regex::must_regex_replace_all_literal as Func,
    ),
