...
local clusters = {
  'dev-eu-south-0': {
    cluster_name: 'dev-eu-south-0',
    apiServer: 'https://dev-eu-south-0.example.com',
  },
  'prod-us-east-0': {
    cluster_name: 'prod-us-east-0',
    apiServer: 'https://prod-us-east-0.example.com',
  },
};
  ...
  environment(clusterName)::
    ...
    local helmResources = std.native('helmTemplate')(
      ...
      './charts/flagger-chart',
      {
        ...
        includeCrds: clusterName == 'dev-eu-south-0',
        values: {
