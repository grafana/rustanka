...
local endpointMapping = {
  '10': 'http://service-10.local/push',
  '100': 'http://service-100.local/push',
  '105': 'http://service-105.local/push',
  '132': 'http://service-132.local/push',
  '188': 'http://service-188.local/push',
  '67': 'http://service-67.local/push',
};
