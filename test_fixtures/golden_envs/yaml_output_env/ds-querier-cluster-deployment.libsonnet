      ...
      },
      {
          ...
          overrides: [
            {
              ...
              matcher: {
                ...
                options: {
                  mode: 'exclude',
                  names: [
                    'prod-eu-west-2-hosted-grafana-api-mysql8',
                  ],
                  prefix: 'All except:',
                  readOnly: true,
                },
        ...
        targets: [
          ...
          },
          {
            ...
            editorMode: 'code',
            expr: 'max(\n    azure_mysql_server_cpu_percent{instance_name=~"$cluster-hosted-grafana-.*-mysql8.*|$cluster-hosted-grafana.*-api.*|$cluster-mysql-\\\\d-.*"}\n) by (instance_name)\n/ 100',
            hide: false,
            instant: false,
